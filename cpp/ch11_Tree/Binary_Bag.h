...
namespace binaryBag
{
    ...
    private:
        ...
        void insert_all(binary_tree<Item>* addroot_ptr);
    };
    ...
    template <class Item>
	void bst_remove_max(binary_tree<Item>*& root_ptr, Item& removed)
    ...
    template <class Item>
	bool bst_remove(binary_tree<Item>*& root_ptr, const Item& target)
	...
	(binary_tree<Item>*& root_ptr, const Item& target)
	// Precondition: root_ptr is a root pointer of a binary search tree 
	// or may be NULL for an empty tree).
    ...
    template <class Item>
	void bag<Item>::insert_all(binary_tree<Item> * addroot_ptr)
